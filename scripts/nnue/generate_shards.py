...
def validate_args(args: argparse.Namespace) -> None:
    ...
    if args.nodes < 1 or args.min_ply < 0 or args.max_ply < args.min_ply:
        raise SystemExit("invalid teacher or ply configuration")
    if args.max_games < 0 or args.max_positions_per_shard < 0:
...
def merge_shards(paths: list[Path], destination: Path, seen: set[int] | None) -> dict[str, int]:
...
def main() -> int:
    ...
    for index in range(args.shards):
        ...
        command = [
            ...
            "--max-positions", str(args.max_positions_per_shard), "--seed", str(args.seed),
        ...
        expected = {
            ...
            "sampling": {
                ...
                "maxPositions": args.max_positions_per_shard,
    ...
    training_merge = merge_shards(training_parts, training_output, seen)
    ...
    manifest = {
        ...
        "sampling": {"seed": args.seed, "sampleRate": args.sample_rate,
                     ...
                     "maxGames": args.max_games,
                     "maxPositionsPerShard": args.max_positions_per_shard,
                     "validationFractionByGame": args.validation_fraction},
